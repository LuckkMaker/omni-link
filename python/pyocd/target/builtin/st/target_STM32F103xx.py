...
class STM32F103C8(CoreSightTarget):
    ...
    def __init__(self, session):
        super(STM32F103C8, self).__init__(session, self.MEMORY_MAP)
...
class STM32F103CB(CoreSightTarget):
    ...
    def __init__(self, session):
        super(STM32F103CB, self).__init__(session, self.MEMORY_MAP)
        self._svd_location = SVDFile.from_builtin("STM32F103xx.svd")
...
class STM32F103RB(CoreSightTarget):
    ...
    def __init__(self, session):
        super(STM32F103RB, self).__init__(session, self.MEMORY_MAP)
        self._svd_location = SVDFile.from_builtin("STM32F103xx.svd")
...
class STM32F103VE(CoreSightTarget):
    ...
    def __init__(self, session):
        super(STM32F103VE, self).__init__(session, self.MEMORY_MAP)
        self._svd_location = SVDFile.from_builtin("STM32F103xx.svd")
...
class STM32F103ZE(CoreSightTarget):
    ...
    def __init__(self, session):
        super(STM32F103ZE, self).__init__(session, self.MEMORY_MAP)
        self._svd_location = SVDFile.from_builtin("STM32F103xx.svd")
...
class STM32F103ZG(CoreSightTarget):

    VENDOR = "STMicroelectronics"

    MEMORY_MAP = MemoryMap(
        FlashRegion(    start=0x08000000,  length=0x100000,     blocksize=0x800, is_boot_memory=True,
            algo=FLASH_ALGO),
        RamRegion(      start=0x20000000,  length=0x18000)
        )

    def __init__(self, session):
        super(STM32F103ZG, self).__init__(session, self.MEMORY_MAP)
        self._svd_location = SVDFile.from_builtin("STM32F103xx.svd")
