...
#
# APM32F415 generic target: 1MB Flash, 128KB SRAM + 64KB CCM.
# Replaces APM32F415RG/VG/ZG (same flash capacity).
#
...
class APM32F415xG(CoreSightTarget):
    """APM32F415: 1MB Flash, 128KB SRAM + 64KB CCM."""
