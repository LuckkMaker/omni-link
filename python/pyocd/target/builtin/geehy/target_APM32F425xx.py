...
#
# APM32F425 generic target: 1MB Flash, 128KB SRAM + 64KB CCM.
# Replaces APM32F425ZG/VG/RG/CG (same flash capacity).
#
...
class APM32F425xG(CoreSightTarget):
    """APM32F425: 1MB Flash, 128KB SRAM + 64KB CCM."""
    ...
    def __init__(self, session):
        ...
        self._svd_location = SVDFile.from_builtin("APM32F425.svd")
