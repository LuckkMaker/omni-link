...
#
# APM32F465 generic target: 512KB Flash, 128KB SRAM + 64KB CCM.
# Replaces APM32F465VE/RE (same flash capacity).
#

from ....coresight.coresight_target import CoreSightTarget
from ....core.memory_map import (FlashRegion, RamRegion, MemoryMap)
from ....debug.svd.loader import SVDFile
from .target_APM32F4xx_flash import FLASH_ALGO_465_512K

CHIP_ERASE_WEIGHT = 15.0


class APM32F465xE(CoreSightTarget):
    """APM32F465: 512KB Flash, 128KB SRAM + 64KB CCM."""
    ...
    MEMORY_MAP = MemoryMap(
        FlashRegion(start=0x08000000, length=0x10000, sector_size=0x4000,
                    ...
                    erase_all_weight=CHIP_ERASE_WEIGHT, algo=FLASH_ALGO_465_512K),
    ...
    def __init__(self, session):
        ...
        self._svd_location = SVDFile.from_builtin("APM32F465.svd")
