...
datas = [('D:\\workspaces\\project\\omni-link\\python\\data', 'data'), ('D:\\workspaces\\project\\omni-link\\python\\flm', 'flm')]
binaries = []
...
a = Analysis(
    ['D:\\workspaces\\project\\omni-link\\python\\server.py'],
    pathex=['D:\\workspaces\\project\\omni-link\\python'],
    binaries=binaries,
    datas=datas,
