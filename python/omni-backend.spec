...
datas = [('D:\\workspaces\\project\\omni-work\\python\\data', 'data'), ('D:\\workspaces\\project\\omni-work\\python\\flm', 'flm')]
binaries = []
...
a = Analysis(
    ['D:\\workspaces\\project\\omni-work\\python\\server.py'],
    pathex=['D:\\workspaces\\project\\omni-work\\python'],
    binaries=binaries,
    datas=datas,
