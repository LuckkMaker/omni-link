...
datas = [('D:\\workspace\\embedded\\omni-link\\python\\data', 'data'), ('D:\\workspace\\embedded\\omni-link\\python\\flm', 'flm')]
binaries = []
...
a = Analysis(
    ['D:\\workspace\\embedded\\omni-link\\python\\server.py'],
    pathex=['D:\\workspace\\embedded\\omni-link\\python'],
    binaries=binaries,
    datas=datas,
