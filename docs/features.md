...
<!-- ============ Hero ============ -->
<div class="omni-hero omni-hero--pages">
  <div class="omni-hero-inner">
    <h1 class="reveal">认识 OMNI Link 的<span class="accent">每一个页面</span></h1>
    <p class="hero-sub reveal">从代码调试到固件烧录，从实时日志到变量波形，每个页面都专注解决一类调试场景，并整合在同一个工作台里，无需在多个工具之间来回切换。</p>
    <div class="hero-meta reveal">
      <span class="chip"><span class="dot"></span>v0.4.2</span>
      <span class="chip">MIT 开源</span>
      <span class="chip">支持 DAPLink / ST-Link / J-Link</span>
      <span class="chip">Windows 10+</span>
    </div>
  </div>
</div>
...
<div class="omni-pages">
  ...
  <!-- ============ Zone 调试工作台 ============ -->
  <section class="page-block" id="zone">
    ...
    <div class="page-info reveal">
      ...
      <h3>Zone 调试工作台</h3>
      <p>应用的主页面，采用 SEGGER Ozone 式布局，把源码调试、反汇编、寄存器、外设、调用栈、变量监视与内存查看整合进一个视图，让每一行代码的执行痕迹都触手可及。</p>
      <ul class="page-feats">
  ...
  <section class="page-block" id="commander">
    ...
    <div class="page-info reveal">
      ...
      <h3>Commander 命令行</h3>
      <p>交互式 REPL，复用 pyOCD Commander 的全部能力。右侧命令面板把常用命令归类为快捷按钮，「调试」「断点调试」「解锁刷写」三套一键工作流，将多步命令链简化为单击操作。</p>
      <ul class="page-feats">
